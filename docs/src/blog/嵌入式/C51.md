...
```c
unsigned char code Int_OLED_Font[][16] = {
...
```c
//显示字符
void Int_OLED_ShowStr(unsigned char x, unsigned char y, unsigned char *str)
{
    unsigned char i;
    unsigned char cmd_bytes[2];
    // 设置OLED寻址方式
...
<image src="https://raw.githubusercontent.com/Lazydd/images/main/202412051718428.png" />
